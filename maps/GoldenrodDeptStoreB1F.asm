	...
	const GOLDENRODDEPTSTOREB1F_YOUNGSTER
...
GoldenrodDeptStoreB1FYoungsterScript:
	faceplayer
	opentext
...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event  5,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FYoungsterScript, -1
